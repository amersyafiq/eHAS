                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb mb-0">
                                            <li class="breadcrumb-item">
                                                <a href="${pageContext.request.contextPath}/appointment">Appointments</a>
                                            </li>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row px-4 g-2">
                                        ...
                                        <c:if test="${appt.status == 'PENDING'}">
                                            <form method="POST" action="${pageContext.request.contextPath}/appointment/page/confirm" class="col-12">
                                                <input type="hidden" name="appointmentID" value="${appt.appointmentid}">
                                                <button 
                                                    onclick="if(confirm('WARNING: Are you sure you want to CONFIRM this appointment?')) this.submit();"
                                                    class="btn btn-primary w-100 d-flex flex-column align-items-center rounded-3 justify-content-center py-3 gap-2" >
                                                    <svg width="25" height="25" viewBox="0 0 27 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M25.1907 6.25004L22.0579 4.57519L20.2495 1.67484H16.6325L13.4997 0L10.3669 1.67484H6.74984L4.94105 4.57563L1.8088 6.25004V9.59921L0 12.5L1.8088 15.4008V18.75L4.94159 20.4248L6.75039 23.3256H10.3674L13.4998 25L16.6326 23.3252H20.2496L22.0584 20.4244L25.1912 18.7495V15.4004L27 12.4996L25.1912 9.59878V6.25004H25.1907ZM12.2813 17.6161C12.0296 17.8492 11.6979 17.9625 11.3678 17.9582C11.0376 17.9626 10.706 17.8492 10.4543 17.6161L6.50611 13.9603C6.01153 13.5024 6.01153 12.7595 6.50611 12.3015L7.55132 11.3337C8.0459 10.8757 8.84824 10.8757 9.34282 11.3337L11.3678 13.2087L17.6562 7.38554C18.1508 6.92758 18.9532 6.92758 19.4477 7.38554L20.4929 8.35334C20.9875 8.81129 20.9875 9.55421 20.4929 10.0122L12.2813 17.6161Z" fill="white"/>
                                                    </svg>
                                                    Confirm Appointment
                                                </button>
                                            </form>
                                        ...
                                        <c:if test="${appt.status == 'CONFIRMED'}">
                                            <div class="col-12">
                                                <button 
                                                    onclick="if(confirm('NOTICE: Are you sure you want to START the consultation?')) location.href='${pageContext.request.contextPath}/appointment/consultation?id=${appt.appointmentid}'"
                                                    class="btn btn-primary w-100 d-flex flex-column align-items-center rounded-3 justify-content-center py-3 gap-2" >
                                                    <svg width="25" height="25" viewBox="0 0 27 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M25.1907 6.25004L22.0579 4.57519L20.2495 1.67484H16.6325L13.4997 0L10.3669 1.67484H6.74984L4.94105 4.57563L1.8088 6.25004V9.59921L0 12.5L1.8088 15.4008V18.75L4.94159 20.4248L6.75039 23.3256H10.3674L13.4998 25L16.6326 23.3252H20.2496L22.0584 20.4244L25.1912 18.7495V15.4004L27 12.4996L25.1912 9.59878V6.25004H25.1907ZM12.2813 17.6161C12.0296 17.8492 11.6979 17.9625 11.3678 17.9582C11.0376 17.9626 10.706 17.8492 10.4543 17.6161L6.50611 13.9603C6.01153 13.5024 6.01153 12.7595 6.50611 12.3015L7.55132 11.3337C8.0459 10.8757 8.84824 10.8757 9.34282 11.3337L11.3678 13.2087L17.6562 7.38554C18.1508 6.92758 18.9532 6.92758 19.4477 7.38554L20.4929 8.35334C20.9875 8.81129 20.9875 9.55421 20.4929 10.0122L12.2813 17.6161Z" fill="white"/>
                                                    </svg>
                                        ...
                                        <c:if test="${appt.status == 'PENDING' || appt.status == 'CONFIRMED'}">
                                            <form method="POST" action="${pageContext.request.contextPath}/appointment/page/cancel" class="col-12">
                                                <input type="hidden" name="appointmentID" value="${appt.appointmentid}">
                                                <button 
